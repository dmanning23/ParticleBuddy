...
namespace ParticleBuddy
{
	public class EmitterTemplate
	{
		...
		{
			//load the resource
			SPFSettings.ParticleXML myDude = rXmlContent.Load<SPFSettings.ParticleXML>(strResource);
			return ReadSerializedObject(myDude, rRenderer);
		}

		public bool ReadSerializedObject(SPFSettings.ParticleXML myParticle, IRenderer rRenderer)
		{
